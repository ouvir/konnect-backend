...
-- Schema ssafytrip
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `konnect` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci ;
USE `konnect` ;

-- -----------------------------------------------------
-- Table `ssafytrip`.`sidos`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `konnect`.`sidos` ;

CREATE TABLE IF NOT EXISTS `konnect`.`sidos` (
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `konnect`.`guguns` ;

CREATE TABLE IF NOT EXISTS `konnect`.`guguns` (
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `konnect`.`contenttypes` ;

CREATE TABLE IF NOT EXISTS `konnect`.`contenttypes` (
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `konnect`.`attractions` ;

CREATE TABLE IF NOT EXISTS `konnect`.`attractions` (
